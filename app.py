...
with col_pad2:
    with st.expander("🔒 Haz clic aquí para abrir el candado secreto"):
        ...
        if code == "2604":
            ...
            with col_pad1:
                st.markdown("""
                    <div class="gif-fixed-box"><img src="https://raw.githubusercontent.com/maoliveroc304/Un-lindo-final/main/fotos/gifs/gato1.gif"></div>
                    <br>
                    <div class="gif-fixed-box"><img src="https://raw.githubusercontent.com/maoliveroc304/Un-lindo-final/main/fotos/gifs/gato2.gif"></div>
                """, unsafe_allow_html=True)
            ...
            with col_pad3:
                st.markdown("""
                    ...
                    <br>
                    <div class="gif-fixed-box"><img src="https://raw.githubusercontent.com/maoliveroc304/Un-lindo-final/main/fotos/gifs/gato4.gif"></div>
                """, unsafe_allow_html=True)
